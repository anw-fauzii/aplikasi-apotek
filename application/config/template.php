...
$template['bootstrap']['regions'] = array(
   ...
   'content',
   'footer' => array(
        'content' => array('<p>Copyright &copy; STT Rizwan</p>'),
    ),
);
...
$template['default']['regions'] = array(
   'title' => array('content' => array('Toko Obat Lestari')),
   'header',
   'content',
   'navs',
   'footer' => array(
        'content' => array('<p>STT Rizwan &copy; 2018</p>'),
    ),
);
...
$template['body']['regions'] = array(
   'title' => array('content' => array('Apotek Lestari')),
   'header',
   'navs',
   'sidenavs',
   'content',
   'footer' => array(
        'content' => array('STT Rizwan; 2022'),
    ),
);
